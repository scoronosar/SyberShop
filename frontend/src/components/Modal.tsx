...
export const Modal = ({ open, onClose, title, children }: Props) => {
  ...
  return (
    ...
    >
      <div 
        className="w-full max-w-lg max-h-[85vh] bg-white rounded-2xl shadow-2xl p-6 animate-scale-in flex flex-col"
      ...
      >
        ...
        <div className="text-sm text-gray-800 overflow-y-auto pr-1">{children}</div>
      </div>
    </div>
  );
};
