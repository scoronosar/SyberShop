    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-gray-50 to-white">
      ...
      <header className="sticky top-0 z-50 backdrop-blur-xl bg-white/95 border-b-2 border-gray-100 shadow-lg">
        <div className="container-xl">
          <div className="flex flex-col lg:flex-row lg:items-center gap-4 py-3 lg:py-4">
            {/* Logo Section - Always visible */}
            <Link 
              to="/" 
              className="group shrink-0 flex items-center gap-3 hover:scale-105 transition-transform duration-300"
            >
              <div className="relative">
                <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-primary-500 via-primary-600 to-amber-500 flex items-center justify-center shadow-xl group-hover:shadow-2xl group-hover:shadow-primary-300/50 transition-all duration-300">
              ...
              <div className="flex flex-col leading-tight">
                <span className="text-xl lg:text-2xl font-extrabold bg-gradient-to-r from-primary-600 via-primary-500 to-amber-500 bg-clip-text text-transparent">
                  SyberShop
                </span>
                <span className="text-[10px] font-bold text-gray-500 tracking-wider">TAOBAO GLOBAL</span>
              </div>
            </Link>
            ...
            >
              <div className="flex-1 relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <svg 
                    className="w-5 h-5 text-gray-400 group-focus-within:text-primary-500 transition-colors duration-200" 
                    fill="none" 
                    stroke="currentColor" 
                    viewBox="0 0 24 24"
                  >
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 px-3 sm:px-4 flex items-center gap-1.5 sm:gap-2 hover:bg-primary-50 transition-all rounded-r-xl sm:rounded-r-2xl group/img"
                  title="Поиск по изображению"
                >
                  <span className="text-lg sm:text-xl group-hover/img:scale-110 transition-transform">📷</span>
